package com.luka.lbdb.planning.plan.planTypes.update;
...
/// Plan for the "select" relational algebra operator. Update operations.
public class SelectPlan implements Plan<UpdateScan> {
    ...
    public UpdateScan open() {
        return new SelectScan(childPlan.open(), predicate);
    }
