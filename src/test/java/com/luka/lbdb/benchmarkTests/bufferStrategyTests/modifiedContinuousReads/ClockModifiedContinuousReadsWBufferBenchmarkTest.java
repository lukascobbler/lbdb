...
public class ClockModifiedContinuousReadsWBufferBenchmarkTest extends AbstractWBufferStrategyBenchmarkTest {
    public ClockModifiedContinuousReadsWBufferBenchmarkTest() {
        super(BufferStrategy.CLOCK, BufferTestType.CONTINUOUS_READS_M);
    }
}