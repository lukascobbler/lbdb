...
public class FifoContinuousReadsROBufferBenchmarkTest extends AbstractROBufferStrategyBenchmarkTest {
    public FifoContinuousReadsROBufferBenchmarkTest() {
        super(BufferStrategy.FIFO, BufferTestType.CONTINUOUS_READS);
    }
}
