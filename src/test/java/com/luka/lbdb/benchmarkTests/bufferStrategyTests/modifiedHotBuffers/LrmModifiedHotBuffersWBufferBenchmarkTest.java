...
@Tag("HOT_BUFFERS_M")
public class LrmModifiedHotBuffersWBufferBenchmarkTest extends AbstractWBufferStrategyBenchmarkTest {
    public LrmModifiedHotBuffersWBufferBenchmarkTest() {
        super(BufferStrategy.LRM, BufferTestType.HOT_BUFFERS_M);
    }
}
