...
@Tag("HOT_BUFFERS_M")
public class ClockModifiedHotBuffersWBufferBenchmarkTest extends AbstractWBufferStrategyBenchmarkTest {
    public ClockModifiedHotBuffersWBufferBenchmarkTest() {
        super(BufferStrategy.CLOCK, BufferTestType.HOT_BUFFERS_M);
    }
}