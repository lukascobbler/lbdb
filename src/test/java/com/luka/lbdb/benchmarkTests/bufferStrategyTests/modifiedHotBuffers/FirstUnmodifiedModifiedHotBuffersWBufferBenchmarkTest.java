...
@Tag("HOT_BUFFERS_M")
public class FirstUnmodifiedModifiedHotBuffersWBufferBenchmarkTest extends AbstractWBufferStrategyBenchmarkTest {
    public FirstUnmodifiedModifiedHotBuffersWBufferBenchmarkTest() {
        super(BufferStrategy.FIRST_UNMODIFIED, BufferTestType.HOT_BUFFERS_M);
    }
}