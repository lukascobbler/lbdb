...
public class LrmModifiedContinuousReadsWBufferBenchmarkTest extends AbstractWBufferStrategyBenchmarkTest {
    public LrmModifiedContinuousReadsWBufferBenchmarkTest() {
        super(BufferStrategy.LRM, BufferTestType.CONTINUOUS_READS_M);
    }
}
